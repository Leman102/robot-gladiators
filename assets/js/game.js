...
var fightOrSkip = function () {
    ...
    if (!promptFight) { // Check for  Falsy values such as 0, null, "", undefined, NaN, and false
...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        if(isPlayerTurn){
        //adding fight or skip prompt 
            if(fightOrSkip()){
                //if true(they want to skip) break loop
                break;
            };
...
var shop = function() {
    ...
    shopOptionPrompt = parseInt(shopOptionPrompt); //built-in JavaScript function that converts strings to integers.
